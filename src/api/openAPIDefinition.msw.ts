...
export const getGetBankAccountResponseMock = (overrideResponse: Partial< BankAccount > = {}): BankAccount => ({id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), accountNumber: faker.string.alpha(20), branch: {id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), bank: {id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), bankName: faker.string.alpha(20), bankShortName: faker.string.alpha(20), swiftCode: faker.helpers.arrayElement([faker.string.alpha(20), undefined])}, name: faker.string.alpha(20), relatedEmployee: faker.string.alpha(20)}, iban: faker.string.alpha(20), currency: {currencyCode: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), numericCode: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), numericCodeAsString: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), displayName: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), symbol: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), defaultFractionDigits: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])}, ...overrideResponse})
...
export const getGetServiceGroupTreeResponseMock = (overrideResponse: Partial< ServiceGroupTree > = {}): ServiceGroupTree => ({serviceGroups: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), name: faker.string.alpha(20), code: faker.string.alpha(20), children: faker.helpers.arrayElement([[], undefined])})), undefined]), ...overrideResponse})

export const getGetProductGroupTreeResponseMock = (overrideResponse: Partial< ProductGroupTree > = {}): ProductGroupTree => ({productGroups: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), name: faker.string.alpha(20), code: faker.string.alpha(20), children: faker.helpers.arrayElement([[], undefined])})), undefined]), ...overrideResponse})

export const getGetMaterialGroupTreeResponseMock = (overrideResponse: Partial< MaterialGroupTree > = {}): MaterialGroupTree => ({message: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), error: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), materialGroups: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), name: faker.string.alpha(20), code: faker.string.alpha(20), children: faker.helpers.arrayElement([[], undefined])})), undefined]), ...overrideResponse})

export const getGetFixtureGroupTreeResponseMock = (overrideResponse: Partial< FixtureGroupTree > = {}): FixtureGroupTree => ({fixtureGroups: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), undefined]), name: faker.string.alpha(20), code: faker.string.alpha(20), children: faker.helpers.arrayElement([[], undefined])})), undefined]), ...overrideResponse})
...
export const getGetServiceCardMockHandler = (overrideResponse?: ServiceCard | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ServiceCard> | ServiceCard)) => {
...
export const getGetFixtureCardMockHandler = (overrideResponse?: FixtureCard | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<FixtureCard> | FixtureCard)) => {
...
export const getGetServiceGroupTreeMockHandler = (overrideResponse?: ServiceGroupTree | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ServiceGroupTree> | ServiceGroupTree)) => {
...
export const getGetProductGroupTreeMockHandler = (overrideResponse?: ProductGroupTree | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ProductGroupTree> | ProductGroupTree)) => {
...
export const getGetMaterialGroupTreeMockHandler = (overrideResponse?: MaterialGroupTree | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<MaterialGroupTree> | MaterialGroupTree)) => {
...
export const getGetFixtureGroupTreeMockHandler = (overrideResponse?: FixtureGroupTree | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<FixtureGroupTree> | FixtureGroupTree)) => {
