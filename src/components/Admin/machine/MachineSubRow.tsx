...
import { SubFormMachine } from '@/components/Admin/machine/SubFormMachine'

interface MachineSubRowProps<TData> {
  employeeId?: number
  row?: Row<TData>
  handleExpandRow?: (e: MouseEvent | null, rowId: string) => void
}

export const MachineSubRow = <TData,>(props: MachineSubRowProps<TData>) => {
